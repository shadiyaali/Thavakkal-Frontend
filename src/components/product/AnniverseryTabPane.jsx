...
const AnniversaryTabPane = () => {
    const {addToCakeCart,addToCakeWishlist,handleProductViewOpen,randomizedCakes} = useContext(FarzaaContext)
  return (
    <div className="row g-3 g-lg-4 justify-content-center"> 
        {randomizedCakes.slice(-8).map((item) => (
...
export default AnniversaryTabPane